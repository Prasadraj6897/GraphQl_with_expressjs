...
const OwnerType = new GraphQLObjectType({
  ...
  // atrribute for returning array
const RootQueryType = new GraphQLObjectType({
    name: 'Query',
    description: 'Root Query',
    fields: () => ({

        // To query all like select * from website or 
    ...
    //Specific query field ends here

  })

  // for mutation (like Add, Update, Delete, )
